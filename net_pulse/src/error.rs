...
use crate::dispatch_center::ChannelId;

#[derive(Debug)]
pub(crate) enum UnexpectedErrorKind {
    DurationIsMissing,
...
pub enum DispatchError<T> {
    ...
    WritingSendError(Vec<DispatchError<T>>),
    ...
    NotSubscribeMultiple(Vec<DispatchError<M>>),
